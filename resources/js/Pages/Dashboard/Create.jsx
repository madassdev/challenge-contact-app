...
function Create({ categories }) {
    ...
    // function
    useEffect(() => {
        const data = categories.map((cat) => ({ ...cat, selected: false }));
    ...
    const [location, setLocation] = useState({ show: false, lat: 45, lng: 3 });
                            ...
                            >
                                <div className="w-12 h-12 border-2 border-blue-600/80 relative rounded-full grid place-content-center">
                                    {data.image ? (
                                        <>
                                            <span
                                                className="absolute -right-8 tsop-6 bottom-2 p-1 rounded-full text-red-900"
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    e.preventDefault();
                                                    setData((d) => ({
